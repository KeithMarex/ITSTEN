<template>
  <div class="authentication">
      ...
      <div class="headerLogin">
          ...
          <a @click="redirect('Login')" style="border-left: 10px solid transparent" id="login-button">
              Login / Register
      ...
      <component style="margin-left: 10px" @updateRoute="redirect($event)" v-bind:is="componentName"></component>
  </div>
</template>
